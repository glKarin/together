...
var QQ_FACE = "qq_face";
var QQ_FACE_WIDTH = 29;
var QQ_FACE_HEIGHT = 29;
var QQ_FACE_COLS = 15;
var QQ_FACE_ROWS = 7;
var QQ_FACE_IMG_SRC = Qt.resolvedUrl("../../resc/qq_face.png");
...
var EMOJI_COLS = 15;
var EMOJI_ROWS = 12;
var EMOJI_IMG_SRC = Qt.resolvedUrl("../../resc/emoji.png");

function CreateModel(model, type)
{
	var t = type === EMOJI ? 1 : 0;

	var w = t === 1 ? EMOJI_WIDTH : QQ_FACE_WIDTH;
	var h = t === 1 ? EMOJI_HEIGHT : QQ_FACE_HEIGHT;
	var src = t === 1 ? EMOJI_IMG_SRC : QQ_FACE_IMG_SRC;
	var cols = t === 1 ? EMOJI_COLS : QQ_FACE_COLS;
	var rows = t === 1 ? EMOJI_ROWS : QQ_FACE_ROWS;
	var arr = t === 1 ? EmojiList : QQFaceList;

	ModelClear(model);
	var r = 0;
	for(var i in arr)
	{
		var index = parseInt(t === 1 ? i : QQFaceMap[arr[i]]);
		var m = index % cols;
		var x = w * m;
		var y = h * r;
		var name = arr[i];
		...
		var item = {
			...
			src: src,
			name: name,
			value: t === 1 ? (QQFaceMap[name_1] !== undefined && EmojiCodeMap[QQFaceMap[name_1]] !== undefined ? EmojiCodeMap[QQFaceMap[name_1]] : name_2) : name_2,
		};
		if(i != 0 && i % cols === 0)
			r++;
		//console.log(i, m, r, x, y, item.name, item.value);
		ModelPush(model, item);
	}
}

...
class QDeclarativeWebView : public QDeclarativeItem {
    ...
    Q_PROPERTY(bool dontDelegateLinks READ DontDelegateLinks WRITE SetDontDelegateLinks NOTIFY dontDelegateLinksChanged)
...
public:
    ...
    bool DontDelegateLinks() const;
    void SetDontDelegateLinks(bool b);
...
Q_SIGNALS:
    ...
    void dontDelegateLinksChanged(bool);
    void javaScriptConsoleMessage(const QString &message, int lineNumber, const QString &sourceID);

private:
    void Init();
    void SetLinkDelegationPolicy(QWebPage *p = 0);
    void SetupPage(QWebPage* page = 0);
